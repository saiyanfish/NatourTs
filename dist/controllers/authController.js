...
const authController = {
    logIn: (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!email || !password) {
            return next(new appError_1.default('Plz provide your password or email', 400));
        }
    ...
    signUp: (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
